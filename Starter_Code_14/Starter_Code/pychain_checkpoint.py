...
################################################################################
# All of my imports to this streamlit app to run
...
# Created a new dataclass and named the class "Record"
# Created 3 attributes (selected, receiver, amount)
# We made selected a str, receiver a str, and amount a float
@dataclass
class Record:
    selected: str
    receiver: str
...
# We would have to rename the our data attribute to now be called "Record", this is done to refer back to out Record class above
...
# This will help us add the cache decorator for Streamlit to run
...
# input_sender creates a variable for the user to input into the streamit application
# we created tect_inputs for "Sender", "Receiver", and "Amount"
...
if st.button("Add Block"):
    ...
    # Over here we made it so that whenever we have to update our block, this will create a record of the previous transaction 
    # the record will show the last transaction for the "input_sender,input_receiver, input_amount"
...
# This will creates the chart slider on the left side of the Streamlit Application 
